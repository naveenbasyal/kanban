    ...
    >
      <div className="brand-name">
        ...
        >
          ...
          <span className="text-heading dark:text-slate-300">Kanbuddy</span>
        </Link>
      </div>

      <div className="allboards gap-5 w-full">
        <h3 className="text-purple dark:text-slate-300 font-[600] text-[1.7rem]">
          My Boards
        </h3>
        ...
        <div className="relative w-full">
          <button
            ...
            type="button"
            className="relative hover:bg-indigo-100 dark:hover:bg-slate-800 mt-3 w-full cursor-pointer
             flex justify-between ring-0 outline-none border-none rounded-md bg-transparent 
             py-5 transition-all text-2xl  pl-3 pr-10 text-left text-heading focus:outline-none
              ...
              >
                <g id="Indicator">
                  <circle
                    ...
                    cy="16"
                    r="8"
                    className="fill-[#5a5b80] dark:fill-slate-400"
                  />
                </g>
              </svg>
              <span className="ml-3 capitalize text-[1.35rem] text-purple dark:text-slate-300 font-semibold block truncate">
          ...
          <ul
            className={`absolute z-10  py-4 max-h-56   w-full transition-transform ease-in duration-200
             overflow-y-auto rounded-md bg-purple dark:bg-slate-800 shadow-lg ring-2 dark:ring-1 dark:ring-slate-700 ring-indigo-200
          ...
          >
            {allBoards.length === 0 && (
              <span className="text-purple dark:text-slate-300 text-[1.35rem] font-semibold block truncate p-3">
                No Boards Found
              </span>
            )}
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-5">
                          <span className="text-[1.35rem] text-purple dark:text-slate-300 capitalize">
                            {board?.title}
                          </span>
                        </div>
                      </span>
      ...
      <div className="labels flex flex-col gap-10 w-full">
        {SidebarLabels?.map((label, index) => (
          <div className="flex flex-col gap-5" key={index}>
            <h4 className="text-purple dark:text-slate-300 font-[600] text-[1.7rem]">
              {label.label}
            </h4>
